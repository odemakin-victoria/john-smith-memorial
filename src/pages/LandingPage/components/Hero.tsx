...
import HeroImage from "../../../../public/assets/images/papa-photo.jpg";
    ...
    <section className="min-h-screen flex items-center justify-center bg-gradient-to-b from-gray-50 to-white pt-20">
      <div className="container mx-auto px-4 text-center">
        ...
        <div className="text-center">
          <h1 className="text-3xl md:text-4xl font-semibold animate-fade-in-up  inline-block pb-2">
            JOHN SMITH <br /> AYETERE
          </h1>
